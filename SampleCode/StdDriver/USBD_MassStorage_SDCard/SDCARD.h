 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    NUC123 series SD Card driver header file
 *
 * @note
...
/** @addtogroup NUC123_Library NUC123 Library
  @{
*/

/** @addtogroup NUC123_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC123_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC123_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC123_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC123_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC123_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC123_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC123_SDCARD */

/*@}*/ /* end of group NUC123_Library */
