 ...
 * @brief
 *           Demonstrate how UART transmit and receive data from PC terminal through RS232 interface.
 *
 * @note
...
void UART_FunctionTest()
{
    ...
    */
    ...
    /* Disable Interrupt */
    UART_DisableInt(UART0, (UART_IER_RDA_IEN_Msk | UART_IER_THRE_IEN_Msk | UART_IER_RTO_IEN_Msk));
    g_bWait = TRUE;
