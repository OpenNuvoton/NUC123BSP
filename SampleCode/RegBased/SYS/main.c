 ...
 * @brief
 *           Demonstrate how to change system clock to different PLL frequency and output system clock from CLKO pin.
 *
 * @note
...
void SYS_Init(void)
{
    ...
    /* Set GPC multi-function pin for Clock Output(PC.13) */
